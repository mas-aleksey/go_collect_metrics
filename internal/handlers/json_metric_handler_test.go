...
func TestSaveJsonMetricHandler(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: want{
				statusCode: 422,
				message:    "json: cannot unmarshal string into Go struct field Metrics.value of type float64\n",
			},
		},
		{
		...
		},
		{
			...
			want: want{
				statusCode: 422,
				message:    "json: cannot unmarshal string into Go struct field Metrics.delta of type int64\n",
			},
		},
		{
